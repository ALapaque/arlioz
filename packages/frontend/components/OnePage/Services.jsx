...
function Services({ lightMode }) {
  ...
  return (
    <section id={'services'} className='services section-padding pb-0 block-pattern'>
      <div className='container'>
        <div className='sec-head mb-80'>
          <div className='row'>
            <div className='col-lg-5'>
              <h6 className='sub-title opacity-8 wow fadeInUp'>We can provide you these</h6>
          ...
          <div className='serv-swiper'>
            {
              ...
              <Swiper {...swiperOptions} id='content-carousel-container-unq-serv'>
                {
                  appData.website.services.map((item, index) => (
                    <SwiperSlide
                      key={item.id}
                      className='wow fadeIn'
                      data-wow-delay={`${(appData.website.services.length - index + 1) * 0.2}s`}>
                      <div className='item'>
      ...
      <div className='bg-pattern bg-img'
           data-background={`${lightMode ? '/light/' : '/dark/'}assets/imgs/patterns/bg-line-1.svg`}></div>
    </section>
  )
}
